...
$datos = DB::table('informecapa as ICapa')
			->select(DB::raw('ICapa.Informe_idInforme, ICapa.idInformeCapa, ICapa.tipoInformeCapa, ICapa.SistemaInformacion_idSistemaInformacion, ICapa.tablaInformeCapa, ICapa.tituloInformeCapa'))
