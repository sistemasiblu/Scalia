...
$datos = DB::table('informecapa as ICap')
			->select(DB::raw('nombreInformeCapa, idInformeConcepto, InformeCapa_idInformeCapa, ordenInformeConcepto, nombreInformeConcepto, nombreNIIFInformeConcepto, tipoMovimientoInformeConcepto, tipoValorInformeConcepto, valorInformeConcepto, valorNIIFInformeConcepto, EstiloInforme_idEstiloInforme, detalleInformeConcepto, resumenInformeConcepto, graficoInformeConcepto, idEstiloInforme, nombreEstiloInforme, colorFondoEstiloInforme, colorBordeEstiloInforme, colorTextoEstiloInforme, fuenteTextoEstiloInforme, tamañoTextoEstiloInforme, negrillaEstiloInforme, italicaEstiloInforme, subrayadoEstiloInforme,  excluirTerceroInformeConcepto'))
