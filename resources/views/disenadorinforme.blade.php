<?php 
	...
	$modo  = (isset($_GET["modo"]) ? $_GET["modo"] : 'C');
...
<div class="clearfix">
	...
	<input type="hidden" id="conceptosEliminados" value=""/>
		...
		<div class="panel panel-primary panelLayout" style="height:135px;">
			...
			<!-- Campos de creacion del informe (nombre y descripcion)  -->
			  <div class="panel-heading" style="height: 38px; font-size: 18px; font-weight: bold; font-style: italic;">
				<div  class="BotonBarraPpal" title="Guardar" style="background-image: url('../imagenes/guardar.png'); " onclick="guardarInforme($('#accionInforme').val());">
				</div>
				<div class="BotonBarraPpal" title="Adicionar Capa General" style="<?php echo (($modo == 'G' or $modo == 'F') ? 'display:inline-block;' : 'display:none;'); ?>background-image: url('../imagenes/adicionarcapageneral.png'); background-color: ;" onclick="adicionarCapa(1, 0, $('#accionInforme').val(), $('#sistemaInformacion').val(), $('#tablaDocumento').val());">
				</div>
				<div class="BotonBarraPpal" title="Adicionar Capa Contable" style="<?php echo (($modo == 'C' or $modo == 'F') ? 'display:inline-block;' : 'display:none;'); ?>background-image: url('../imagenes/adicionarcapacontable.png'); background-color: ;" onclick="adicionarCapa(2, 0, $('#accionInforme').val());">
				</div>
				<div class="BotonBarraPpal" title="Adicionar grupo de datos" style="background-image: url('../imagenes/adicionargrupo.png'); background-color: ;" onclick="adicionarGrupo($('li.active a').attr('href').replace('#capa',''));">
				</div>
					...
					<div class="form-group" id='test'>
			          ...
			          <div class="col-sm-11">
			            <div class="input-group">
			              ...
			              {!! Form::hidden('idInforme', $idInforme, array('id' => 'idInforme')) !!}
			              {!! Form::hidden('idCategoria', $idCategoria, array('id' => 'idCategoria')) !!}
			              {!! Form::hidden('accionInforme', $accion, array('id' => 'accionInforme')) !!}
			              {!! Form::hidden('modoInforme', $modo, array('id' => 'modoInforme')) !!}
			            </div>
			          </div>
			        </div>
	...
	<div id="panelInferior">
		...
		<div id="panelIzquierdo">
			...
			<div class="panel-group" >
				...
				<div  <?php echo ($modo == 'C' ? 'style="display:none;"' : ''); ?> class="panel panel-primary">
						<div class="panel-heading">
							<h5 class="panel-title">
					...
					<table class="table table-striped" style='width:100%;'>
					    <tbody>
					      ...
					      <tr>
					        ...
					        <td>
								<div id="CPcolorFondoParInformePropiedad" class="input-group colorpicker-component" style="width: 100%;">
								  <input id="colorFondoParInformePropiedad" type="hidden" value="#E6E6E6" class="form-control"/>
					        ...
					        <td>
								<div id="CPcolorFondoImparInformePropiedad" class="input-group colorpicker-component" style="width: 100%;">
								  <input id="colorFondoImparInformePropiedad" type="hidden" value="#FFFFFF" class="form-control"/>
								  <span class="input-group-addon"><i style="width: 100%;"></i></span>
								</div>
								<script>
								  $(function () {
					      ...
					      <tr>
					        ...
					        <td>
								<div id="CPcolorBordeParInformePropiedad" class="input-group colorpicker-component" style="width: 100%;">
								  <input id="colorBordeParInformePropiedad" type="hidden" value="#E6E6E6" class="form-control"/>
								  <span class="input-group-addon"><i style="width: 100%;"></i></span>
								</div>
								<script>
								  $(function () {
					        ...
					        <td>
								<div id="CPcolorBordeImparInformePropiedad" class="input-group colorpicker-component" style="width: 100%;">
								  <input id="colorBordeImparInformePropiedad" type="hidden" value="#E6E6E6" class="form-control"/>
								  <span class="input-group-addon"><i style="width: 100%;"></i></span>
								</div>
								<script>
								  $(function () {
					      ...
					      <tr>
					        ...
					        <td>
								<div id="CPcolorTextoParInformePropiedad" class="input-group colorpicker-component" style="width: 100%;">
								  <input id="colorTextoParInformePropiedad" type="hidden" value="#000000" class="form-control"/>
								  <span class="input-group-addon"><i style="width: 100%;"></i></span>
								</div>
								<script>
								  $(function () {
					        ...
					        <td>
								<div id="CPcolorTextoImparInformePropiedad" class="input-group colorpicker-component" style="width: 100%;">
								  <input id="colorTextoImparInformePropiedad" type="hidden" value="#000000" class="form-control"/>
								  <span class="input-group-addon"><i style="width: 100%;"></i></span>
								</div>
								<script>
								  $(function () {
					      ...
					      <tr>
					        ...
					        <td>
					        	<select id="tamañoTextoParInformePropiedad">
									...
									<option style="font-size: 12px;" value="12px" selected="selected">12</option>
					      ...
					      <tr>
					        ...
					        <td>
					        	<!-- <div class="grupoCheckboxGrafico">  -->
...
<div class="modal fade selectorEstilo" data-keyboard="false" data-backdrop="static">
	...
	<div class="modal-dialog" style="height: 100%">
        ...
        <div class="modal-content" style="width: 310px;">
            ...
            <div class="modal-body" style="height:200px;">
	            <div class="containerSelectorEstilo" style="width: 100%;height: 100%;overflow-y:scroll;">
	         	</div> 
            </div>
        </div>
    </div>   
...
<div id="ModalConcepto"  class="modal fade" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" style="width: 1000px; height: 100%">
        <!-- Modal content-->
        <div class="modal-content" >
            ...
            <div class="modal-body" style="height:350px;">
	            ...
	            <fieldset id="accidente-form-fieldset">	
					...
					<div class="form-group" id='test'>
						{!!Form::label('nombreConcepto', 'Concepto Local', array('class' => 'col-sm-4 control-label'))!!}
						<div class="col-sm-8">
				            <div class="input-group">
				              	<span class="input-group-addon">
				                	<i class="fa fa-font"></i>
				              	</span>
								<input type="text" id="nombreConcepto" value="" placeholder"Descripción del Concepto Local" class="form-control" >
							</div>
						</div>
					</div>
					<div class="form-group" id='test'>
						{!!Form::label('nombreNIIFConcepto', 'Concepto NIIF', array('class' => 'col-sm-4 control-label'))!!}
						<div class="col-sm-8">
				            <div class="input-group">
				              	<span class="input-group-addon">
				                	<i class="fa fa-font"></i>
				              	</span>
								<input type="text" id="nombreNIIFConcepto" value="" placeholder"Descripción del Concepto NIIF" class="form-control" >
							</div>
						</div>
					</div>
					...
					<div class="form-group" >
						...
						<div class="col-sm-8">
				            <div id="grupo-tipoMovimientoConcepto" class="input-group">
								...
								<input type="hidden" id="tipoMovimientoConcepto" value="MovimientoContable" >
					...
					<div class="form-group" >
						...
						<div class="col-sm-8">
				            <div id="grupo-tipoValorConcepto" class="input-group">
							    ...
							    <a id="Titulo" onclick="seleccionarBotonTipoValor('tipoValorConcepto', this.id);" title="Título / Texto Fijo"><img id="iconoTituloConcepto" src="http://<?php echo $_SERVER["HTTP_HOST"];?>/imagenes/texto.png" class="botonOpciones"></a>
								    <!-- #A9E2F3 -->
					...
					<div class="form-group" id='test'>
						{!!Form::label('valorConcepto', 'Contenido Concepto Local', array('class' => 'col-sm-4 control-label'))!!}
						<div class="col-sm-8">
				            <div class="input-group">
				              	<span class="input-group-addon">
				                	<i class="fa fa-edit"></i>
				              	</span>
								<input type="text" id="valorConcepto" value="" placeholder"Contenido del Concepto Local" class="form-control" readonly="readonly">
							</div>
						</div>
					</div>

					<div class="form-group" id='test'>
						{!!Form::label('valorNIIFConcepto', 'Contenido Concepto NIIF', array('class' => 'col-sm-4 control-label'))!!}
						<div class="col-sm-8">
				            <div class="input-group">
				              	<span class="input-group-addon">
				                	<i class="fa fa-edit"></i>
				              	</span>
								<input type="text" id="valorNIIFConcepto" value="" placeholder"Contenido del Concepto NIIF" class="form-control" readonly="readonly">
							</div>
						</div>
					</div>
