...
<h3 id="titulo"><center>Componentes</center></h3>
<style>
    tfoot input {
                width: 100%;
                padding: 3px;
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#tactivo').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/mostrarActivoComponentes')!!}",
            "language": {
    ...
    $('#tactivo tbody').on( 'click', 'tr', function () {
     ...
     $('#botonCampo').click(function() {
        ...
        for (var i = 0; i < datos.length; i++) 
        {
            ...
            window.parent.componenteactivo.agregarCampos(valores,'A');  
        }
        window.parent.$("#ModalCampos1").modal("hide");
    });
