...
<h3 id="titulo"><center>Asesores</center></h3>
<style>
    tfoot input 
    {
        width: 100%;
        ...
        <div class="container">
            <div class="row">
                <div class="container">
                    ...
                    <table id="tgrupoestadoasesor" name="tdocumentocrmcargo" class="display table-bordered" width="100%">
                        <thead>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#tgrupoestadoasesor').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/mostrarAsesoresGrupoEstado')!!}",
            "language": {
    ...
    $('#tgrupoestadoasesor tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tgrupoestadoasesor thead th').eq( $(this).index() ).text();
    ...
    $('#tgrupoestadoasesor tbody').on( 'click', 'tr', function () {
     ...
     $('#botonCampo').click(function() {
        ...
        for (var i = 0; i < datos.length; i++) 
        {
            ...
            window.parent.asesores.agregarCampos(valores,'A');  
        }
        window.parent.$("#ModalAsesores").modal("hide");
    });
