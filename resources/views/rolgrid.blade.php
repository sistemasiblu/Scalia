...
@section('titulo')<h3 class="pestana" id="titulo"><center>Roles</center></h3>@stop
@section('content')
<style>
    tfoot input {
                width: 100%;
                    ...
                    <table id="trol" name="trol" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-primary active">
                                ...
                                <a href="rol/create"><span style= "display: <?php echo $visible;?> color:white;" class="glyphicon glyphicon-plus"></span></a>
