...
@section('titulo')<h3 class="pestana" id="titulo"><center>Compañía</center></h3>@stop
@section('content')
<style>
    tfoot input {
                width: 100%;
                    ...
                    <table id="tcompania" name="tcompania" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-primary active">
                                ...
                                <a href="compania/create"><span style= "display: <?php echo $visible;?> color:white;" class="glyphicon glyphicon-plus"></span></a>
