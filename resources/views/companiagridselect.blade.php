            ...
            <div class="row">
                <div class="container">
                    ...
                    <div class="modal-footer">
                        <button id="botonCompañia" name="botonCompañia" type="button" class="btn btn-primary" >Seleccionar</button>
                    </div>
...
<script type="text/javascript">
    ...
    table.columns().every( function () {
     ...
     $('#botonCompañia').click(function() {
        var datos = table.rows('.selected').data();

        for (var i = 0; i < datos.length; i++) 
        {
            var valores = new Array(datos[i][0],datos[i][2],0);
            window.parent.compania.agregarCampos(valores,'A');  
        }

        window.parent.$("#myModalCompania").modal("hide");
        } );
