...
@section('titulo')<h3 class="pestana" id="titulo"><center>Usuarios</center></h3>@stop
@section('content')
<style>
    tfoot input {
                width: 100%;
                ...
                <div class="container">
                    ...
                    <div class="btn-group" style="margin-left: 94%;margin-bottom:0px" title="Columns">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="2"><label> Empleado Asociado</label></a></li>
                            ...
                            <li><a class="toggle-vis" data-column="5"><label> Rol</label></a></li>
                        </ul>
                    </div>
                    <table id="tusuario" name="tusuario" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-primary active">
                                ...
                                <a href="users/create"><span style= "display: <?php echo $visible;?> color:white;" class="glyphicon glyphicon-plus"></span></a>
