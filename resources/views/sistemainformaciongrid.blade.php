...
@section('titulo')<h3 class="pestana" id="titulo"><center>Sistema de Información</center></h3>@stop
@section('content')
<style>
    tfoot input {
                width: 100%;
                    ...
                    <table id="tsistemainformacion" name="tsistemainformacion" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-primary active">
                                ...
                                <a href="sistemainformacion/create"><span style= "display: <?php echo $visible;?> color:white;" class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#tsistemainformacion').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosSistemaInformacion?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
