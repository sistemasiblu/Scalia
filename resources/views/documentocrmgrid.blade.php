                    ...
                    <table id="tdocumentocrm" name="tdocumentocrm" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-primary active">
                                ...
                                <a href="documentocrm/create"><span style= "display: <?php echo $visible;?> color:white;" class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#tdocumentocrm').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosDocumentoCRM?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
