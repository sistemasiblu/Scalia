...
@section('titulo')<h3 id="titulo"><center>Ventas EDI</center></h3>@stop
@section('content')

{!!Html::script('js/ventaedi.js'); !!}
                ...
                <div class="container">
                    ...
                    <input type="hidden" id="token" value="{{csrf_token()}}"/>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="1"><label> Número Reporte</label></a></li>
                    ...
                    <table id="tventaedi" name="tventaedi" class="display table-bordered" width="100%">
                        <thead>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        /*$('#tventaedi').DataTable({
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosVentaEDI')!!}",
        });*/
        var lastIdx = null;
        var modificar = '<?php echo $dato["modificarRolOpcion"];?>';
        var eliminar = '<?php echo $dato["eliminarRolOpcion"];?>';
        var table = $('#tventaedi').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosVentaEDI?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
    ...
    $('#tventaedi tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tventaedi thead th').eq( $(this).index() ).text();
...
<script type="text/javascript">
    ...
    var myDropzone = new Dropzone("div#dropzoneVentaEDIArchivo", {
    ...
    //envio las funciones a realizar cuando se de clic en la vista previa dentro del dropzone
     myDropzone.on("addedfile", function(file) {
          file.previewElement.addEventListener("click", function(reg) {
            ...
            // $("#tituloVentaEDIArchivo").val(fileList[pos]["titulo"]);
          });
        });

    document.getElementById('archivoVentaEDIArray').value = '';
    myDropzone.on("success", function(file, serverFileName) {
                        // abrirModal(file);
                        fileList[i] = {"serverFileName" : serverFileName, "fileName" : file.name,"fileId" : i, "titulo" : '' };
                        // console.log(fileList);

                        document.getElementById('archivoVentaEDIArray').value += file.name+',';
                        // console.log(document.getElementById('archivoVentaEDIArray').value);
                        i++;
                    });
    ...
    <div style="" class="modal-content">
      ...
      <div class="modal-body">
                    ...
                    <div id="upload" class="col-md-9">
                        <div class="input-group col-lg-12 col-md-12" >  
                           <div class="form-group">
                                <div class="input-group col-lg-12 col-md-12">
                                    <div class="dropzone dropzone-previews" id="dropzoneVentaEDIArchivo"  style="height:330px;" ></div>  
                                    {!!Form::hidden('archivoVentaEDI', 0, array('id' => 'archivoVentaEDI'))!!}
                                    {!!Form::hidden('archivoVentaEDIArray', '', array('id' => 'archivoVentaEDIArray'))!!}
                                </div>
                            </div>
                        </div>
                    </div>  
       ...
       <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success"  onclick="ejecutarInterface('importarVentaEDIExcel');" > Importar</button>
