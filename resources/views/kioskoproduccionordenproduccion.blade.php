...
<div id='form-section' >
	...
	<fieldset id="kiosko-form-fieldset"> 
		...
		<div id="contenedor-kiosko">
	        ...
	        {!!Form::label('opOrdenProduccion', 'OP', array('class' => 'col-sm-2 col-sm-2 col-lg-2 control-label')) !!}
	        <div class="col-sm-10">
	          <div class="input-group">
	            <span class="input-group-addon">
	              <i class="fa fa-barcode"></i>
	            </span>
	            {!!Form::text('opOrdenProduccion',null,['class'=>'form-control','placeholder'=>'Digite la OP a consultar'])!!}
	          </div>
	        </div>
	      </div>
			...
			<div id="kiosko-div" class="col-md-12 col-sm-12 col-lg-12">
				...
				<div class="col-md-4 col-sm-4 col-lg-4">
					...
					<a onclick="imprimirOrdenProduccion(document.getElementById('opOrdenProduccion').value,'OrdenProduccion')">
