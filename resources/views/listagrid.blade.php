...
@section('titulo')<h3 class="pestana" id="titulo"><center>Listas</center></h3>@stop
@section('content')
                    ...
                    <table id="tlista" name="tlista" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-primary active">
                                ...
                                <a href="lista/create"><span style= "display: <?php echo $visible;?> color:white;" class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#tlista').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosLista?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
