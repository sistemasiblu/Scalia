...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var lastIdx = null;
        var table = $('#tvalorSelect').DataTable( {
            "order": [[ 0, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosValorConciliacionSelect')!!}",
            "language": {
    ...
    $('#tvalorSelect tfoot th').each( function () {
        
        var title = $('#tvalorSelect thead th').eq( $(this).index() ).text();
    ...
    $('#tvalorSelect tbody').on( 'click', 'tr', function () {
