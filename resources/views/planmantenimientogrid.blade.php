...
<div class="container">
    <div class="row">
        <div class="container">
            ...
            <table id="tplanmantenimiento" name="tplanmantenimiento" class="display table-bordered" width="100%">
                <thead>
                    <tr class="btn-primary active">
                        <th style="width:40px;padding: 1px 8px;" data-orderable="false">
                         <a href="planmantenimiento/create"><span class="glyphicon glyphicon-plus"></span></a>
...
var table = $('#tplanmantenimiento').DataTable( 
{
    "order": [[ 1, "asc" ]],
    "aProcessing": true,
    "aServerSide": true,
    "stateSave":true,
    "ajax": "{!! URL::to ('/datosPlanMantenimiento')!!}",
    "language": 
    {
...
$('#tplanmantenimiento tfoot th').each( function ()
{
    if($(this).index()>0)
    {
    var title = $('#tplanmantenimiento thead th').eq( $(this).index() ).text();
