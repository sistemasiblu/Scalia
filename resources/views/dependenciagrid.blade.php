...
@section('titulo')<h3 class="pestana" id="titulo"><center>Dependencias</h3>@stop
@section('content')
{!!Form::model($datos)!!}
<style>
    tfoot input {
                ...
                <div class="container">
                    ...
                    <div class="btn-group" style="margin-left: 94%;margin-bottom:0px" title="Columns">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="4"><label> Abreviatura</label></a></li>
                        </ul>
                    </div>
                    <table id="tdependencia" name="tdependencia" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-primary active">
                                ...
                                <a href="dependencia/create"><span style= "display: <?php echo $visible;?> color:white;" class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#tdependencia').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosDependencia?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
