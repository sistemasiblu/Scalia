...
<div class="container">
    <div class="row">
        <div class="container">
            ...
            <table id="tasignacionactivo" name="tasignacionactivo" class="display table-bordered" width="100%">
                <thead>
                    <tr class="btn-primary active">
                        <th style="width:40px;padding: 1px 8px;" data-orderable="false">
                         <a href="asignacionactivo/create"><span class="glyphicon glyphicon-plus"></span></a>
...
var table = $('#tasignacionactivo').DataTable( 
{
    "order": [[ 1, "asc" ]],
    "aProcessing": true,
    "aServerSide": true,
...
$('#tasignacionactivo tfoot th').each( function ()
{
    if($(this).index()>0)
    {
    var title = $('#tasignacionactivo thead th').eq( $(this).index() ).text();
