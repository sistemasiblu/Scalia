...
class ProtocoloMantenimientoController extends Controller
{
    ...
    public function create()
    {
        ...
        $frecuencia=\App\FrecuenciaMedicion::lists('nombreFrecuenciaMedicion','idFrecuenciaMedicion');
        return view('protocolomantenimiento',compact('frecuencia','tipoactivo','tipoaccion'));
    }
